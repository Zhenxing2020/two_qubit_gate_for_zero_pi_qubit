...
if __name__ == '__main__':
    ...
    # def wrapped_cz_fidelity_log_noise(args_indep, *arg_select):
    #     try:
    #         print(f"Starting with args_indep={args_indep}")
    #         result = ut.cz_fidelity_log_noise(args_indep, *arg_select)
    #         print(f"Finished with args_indep={args_indep}")
    #         return result
    #     except Exception as e:
    #         print(f"Error with args_indep={args_indep}: {e}")
    #         return None

    # from joblib import parallel_backend
    # with parallel_backend('loky'):  # or 'threading' for debugging
    #     f_noise = Parallel(n_jobs=n_job)(
    #         delayed(wrapped_cz_fidelity_log_noise)(args_indep, *arg_select)
    #         for args_indep in params
    #     )
