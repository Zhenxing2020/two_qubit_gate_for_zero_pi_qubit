...
def get_config():
    ...
    # ---------- Truncation ----------
    cfg["n_truc_list"] = np.arange(200, 400, step=20) # [200] #    
    ...
    cfg["tg_list"] = np.arange(26) # [0::5]#[:1] # [0::6]
    cfg["params"] = np.array([
### charge_truc 400        
...
### No charge_truc 600       
# [29.996927, 0.099229, 0.053777, -0.026484, -0.026168] ,
# [40.008568, 0.097618, 0.048907, -0.028371, -0.027024] ,
# [49.994294, 0.090262, 0.042984, -0.025233, -0.02462] ,
# [60.001278, 0.080869, 0.03972, -0.023165, -0.02295] ,
# [70.008229, 0.073402, 0.037796, -0.021931, -0.021664] ,
# [79.99851, 0.065544, 0.035922, -0.020281, -0.020077] ,
# [89.990552, 0.059363, 0.033747, -0.017895, -0.017941] ,
# [100.004638, 0.053938, 0.031254, -0.014436, -0.01423],
# [110.007114, 0.050069, 0.029384, -0.012834, -0.012428] ,
# [120.001275, 0.047464, 0.02837, -0.011854, -0.011511] ,
# [130.001484, 0.044418, 0.027885, -0.01193, -0.011466] ,
# [140.00192, 0.042909, 0.026824, -0.011366, -0.011035] ,
# [149.996408, 0.040093, 0.025633, -0.010518, -0.010088] ,
# [159.99037, 0.037023, 0.023672, -0.008865, -0.008531] ,
# [169.994121, 0.034785, 0.022416, -0.007929, -0.007574] ,
# [179.997146, 0.032728, 0.021369, -0.007199, -0.006847] ,
...
def print_config(cfg, max_array_rows=5):
    """
